...
variable "lb_source_traffic_name" {
  #HTTP security group name: "Rule-allow-${var.lb_source_traffic_name}-in-HTTP"
  #HTTPS security group name: "Rule-allow-${var.lb_source_traffic_name}-in-HTTPS"
  description = "Name of source traffic for the loadbalancer security group"
  default     = ""
}
