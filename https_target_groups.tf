...
resource "aws_lb_target_group" "tg_https" {
  ...
  count = var.lb_https_listener ? false == var.lb_https_offloading ? length(var.https_target_group_names) == length(var.https_target_group_ports) ? length(var.https_target_group_names) : 0 : 0 : 0
